<template>
<v-container>
  <v-layout align-center column class="mt-5 testBorder">
    <h1 class="text--darken-4"> Whitelisting Process </h1>
    <h4 class="grey--text text--darken-1">Upload your photos to begin the KYC process* and qualify for the EVERLIFE Token Sale and Token Issuance.</h4>
